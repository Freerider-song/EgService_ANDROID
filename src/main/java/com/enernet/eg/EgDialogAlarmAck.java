...
public class EgDialogAlarmAck extends Dialog {

    private CaAlarm m_Alarm;
    private View.OnClickListener m_ClickListenerYes;
    private View.OnClickListener m_ClickListenerNo;

    public EgDialogAlarmAck(Context ctx, CaAlarm alarm, View.OnClickListener ClickListenerYes, View.OnClickListener ClickListenerNo) {
