...
public class CaTask2 extends AsyncTask<CaArg, Void, CaResult> {
    ...
    public CaTask2(final int nCallMethod, final boolean bShowWaitDialog, Context C, IaResultHandler ResultHandler) {
    ...
    public void onPreExecute() {
        ...
        if (m_bShowWaitDialog) {
            ...
            try {
                if (m_Context != null) {
                    String holdOnWait = StringUtil.getString(m_Context, R.string.text_hold_on_wait);
...
;                }
            ...
            String strResponse = httpClient.execute();
