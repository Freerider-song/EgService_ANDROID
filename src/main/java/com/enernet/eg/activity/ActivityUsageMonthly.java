...
import com.enernet.eg.EgYearMonthPicker;
...
public class ActivityUsageMonthly extends BaseActivity implements IaResultHandler {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("ActivityUsageMonthly", "onCreate called...");
    ...
    public void requestUsageMonthly(int nYear, int nMonth) {
        CaApplication.m_Engine.GetUsageOfOneMonth(CaApplication.m_Info.m_nSeqSite, CaApplication.m_Info.m_nSeqMeter,
                nYear, nMonth, this, this);
    }

    public void initChartMonthly()
    {
        m_Chart = findViewById(R.id.chart_monthly);
            ...
            case R.id.btn_select_time: {
                ...
                View.OnClickListener LsnConfirmYes=new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Log.i("YearMonthPicker", "year="+nYear+", month="+nMonth);

                        requestUsageMonthly(nYear, nMonth);
                ...
                m_dlgYearMonthPicker=new EgYearMonthPicker(this, "조회할 월을 선택하세요", LsnConfirmYes, LsnConfirmNo);
    ...
    public void onResult(CaResult Result) {
        ...
        switch (Result.m_nCallback) {
            case CaEngine.CB_GET_USAGE_OF_ONE_MONTH: {
                Log.i("UsageMonthly", "Result of GetUsageOfOneMonth received...");

                try {
                    JSONObject jo = Result.object;

                    String strTargetTime=jo.getString("target_time"); // yyyyMM
            ...
            default: {
                Log.i("UsageMonthly", "Unknown type result received : " + Result.m_nCallback);
            }
            break;
    ...
    public void setDataChart() {
        ...
        if (m_bShowKwh) {
            ...
            YAxis yLeft = m_Chart.getAxisLeft();
            yLeft.setValueFormatter(vfKwhWithUnit);

            YAxis yRight = m_Chart.getAxisRight();
            yRight.setValueFormatter(vfKwhWithUnit);
            ...
            BarDataSet setKwhPrev=new BarDataSet(yValsKwhPrev, "전년 동월 사용량");
            ...
            YAxis yLeft = m_Chart.getAxisLeft();
            yLeft.setValueFormatter(vfWonWithUnit);

            YAxis yRight = m_Chart.getAxisRight();
            yRight.setValueFormatter(vfWonWithUnit);
            ...
            BarDataSet setWonPrev=new BarDataSet(yValsWonPrev, "전년 동월 요금");
    ...
    public void setDataEtc(String strTargetTime, double dSumKwhCurr, double dSumKwhPrev, double dSumKwhAvg,
        ...
        try {
            ...
            Date dtTarget = sdf.parse(strTargetTime);
